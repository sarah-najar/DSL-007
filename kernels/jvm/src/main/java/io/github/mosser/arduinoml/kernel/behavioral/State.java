...
public class State implements NamedElement, Visitable {
    ...
    // Backward compatibility with older API expecting a single transition
    public Transition getTransition() { return transitions.isEmpty() ? null : transitions.get(0); }
    public void setTransition(Transition transition) {
        this.transitions.clear();
        if (transition != null) this.transitions.add(transition);
    }
